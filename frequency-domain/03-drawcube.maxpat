...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 372.0, 158.0, 602.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.plato multiples @name lotsashapes @shape cube @color 1 0.6 0.1 1 @scale 0.1 0.1 0.1 @poly_mode 1 1"
				}
