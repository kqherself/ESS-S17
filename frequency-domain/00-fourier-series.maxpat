...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.0, 403.0, 100.0, 75.0 ],
					"pic" : "/Users/stilesj/Github/Twisted-Signals-F16/08-Spectra/graphics/mr-fourier.png",
					"presentation" : 1,
					"presentation_rect" : [ 53.0, 25.0, 817.0, 612.75 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 224.0, 146.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "adc~"
								}
...
,
									"patching_rect" : [ 195.0, 51.0, 191.0, 71.0 ],
									"varname" : "second",
									"viewvisibility" : 1
								}
...
,
					"patching_rect" : [ 451.0, 148.0, 202.0, 22.0 ],
					"presentation_rect" : [ 558.0, 148.0, 0.0, 0.0 ],
...
,
					"style" : "",
					"text" : "p \"time domain v frequency domain\""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 158.0, 96.0, 899.90802, 435.380615 ],
									"pic" : "/Users/stilesj/Github/Twisted-Signals-F16/00-Intros/media/03 soundwave copy.jpg"
								}
...
,
					"patching_rect" : [ 343.0, 147.0, 94.0, 22.0 ],
					"presentation_rect" : [ 364.0, 149.0, 0.0, 0.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 215.0, 147.0, 108.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-7::obj-6::obj-6" : [ "live.tab[5]", "live.tab[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "03 soundwave copy.jpg",
				"bootpath" : "~/Github/Twisted-Signals-F16/00-Intros/media",
				"type" : "JPEG",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "mr-fourier.png",
				"bootpath" : "~/Github/Twisted-Signals-F16/08-Spectra/graphics",
				"type" : "PNG ",
				"implicit" : 1
			}
 ],
